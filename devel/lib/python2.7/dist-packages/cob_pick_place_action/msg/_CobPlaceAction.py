"""autogenerated by genpy from cob_pick_place_action/CobPlaceAction.msg. Do not edit."""
import sys
...
class CobPlaceAction(genpy.Message):
  _md5sum = "3111cd554bb468b33adbd6c714aa6b1a"
  _type = "cob_pick_place_action/CobPlaceAction"
...
"""
  ...
  _slot_types = ['cob_pick_place_action/CobPlaceActionGoal','cob_pick_place_action/CobPlaceActionResult','cob_pick_place_action/CobPlaceActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CobPlaceAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = cob_pick_place_action.msg.CobPlaceActionGoal()
      if self.action_result is None:
        self.action_result = cob_pick_place_action.msg.CobPlaceActionResult()
      if self.action_feedback is None:
        self.action_feedback = cob_pick_place_action.msg.CobPlaceActionFeedback()
    else:
      self.action_goal = cob_pick_place_action.msg.CobPlaceActionGoal()
      self.action_result = cob_pick_place_action.msg.CobPlaceActionResult()
      self.action_feedback = cob_pick_place_action.msg.CobPlaceActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_goal.goal.destinations)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.destinations:
        _v1 = val1.header
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.destinations = []
      for i in range(0, length):
        ...
        self.action_goal.goal.destinations.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
