"""autogenerated by genpy from cob_pick_place_action/CobPlaceGoal.msg. Do not edit."""
import sys
...
class CobPlaceGoal(genpy.Message):
  _md5sum = "eac848fa6d0bba67596f88cde36f673b"
  _type = "cob_pick_place_action/CobPlaceGoal"
...
"""
  __slots__ = ['object_class','object_name','destinations','support_surface']
  _slot_types = ['uint32','string','geometry_msgs/PoseStamped[]','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       object_class,object_name,destinations,support_surface
    ...
    """
    if args or kwds:
      super(CobPlaceGoal, self).__init__(*args, **kwds)
