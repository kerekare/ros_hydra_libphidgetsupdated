"""autogenerated by genpy from cob_grasp_generation/QueryGraspsAction.msg. Do not edit."""
import sys
...
class QueryGraspsAction(genpy.Message):
  _md5sum = "1ff93f6ea34d66c5322cd3f2f54d29e3"
  _type = "cob_grasp_generation/QueryGraspsAction"
...
"""
  ...
  _slot_types = ['cob_grasp_generation/QueryGraspsActionGoal','cob_grasp_generation/QueryGraspsActionResult','cob_grasp_generation/QueryGraspsActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(QueryGraspsAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = cob_grasp_generation.msg.QueryGraspsActionGoal()
      if self.action_result is None:
        self.action_result = cob_grasp_generation.msg.QueryGraspsActionResult()
      if self.action_feedback is None:
        self.action_feedback = cob_grasp_generation.msg.QueryGraspsActionFeedback()
    else:
      self.action_goal = cob_grasp_generation.msg.QueryGraspsActionGoal()
      self.action_result = cob_grasp_generation.msg.QueryGraspsActionResult()
      self.action_feedback = cob_grasp_generation.msg.QueryGraspsActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2Id3I.pack(_x.action_goal.goal.grasp_id, _x.action_goal.goal.num_grasps, _x.action_goal.goal.threshold, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      length = len(self.action_result.result.grasp_list)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.grasp_list:
        _x = val1.id
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.grasp_id, _x.action_goal.goal.num_grasps, _x.action_goal.goal.threshold, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_2Id3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.grasp_list = []
      for i in range(0, length):
        ...
        self.action_result.result.grasp_list.append(val1)
      _x = self
      start = end
      end += 12
