"""autogenerated by genpy from cob_grasp_generation/QueryGraspsResult.msg. Do not edit."""
import sys
...
class QueryGraspsResult(genpy.Message):
  _md5sum = "fda0067ecf92d75eb0f0b5f6c25d3d37"
  _type = "cob_grasp_generation/QueryGraspsResult"
...
float64 z
"""
  __slots__ = ['success','grasp_list']
  _slot_types = ['bool','moveit_msgs/Grasp[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(QueryGraspsResult, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.grasp_list)
      buff.write(_struct_I.pack(length))
      for val1 in self.grasp_list:
        _x = val1.id
        length = len(_x)
