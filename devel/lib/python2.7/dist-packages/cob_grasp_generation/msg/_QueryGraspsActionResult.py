"""autogenerated by genpy from cob_grasp_generation/QueryGraspsActionResult.msg. Do not edit."""
import sys
...
class QueryGraspsActionResult(genpy.Message):
  _md5sum = "c30242ade55071edc674133f494da278"
  _type = "cob_grasp_generation/QueryGraspsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cob_grasp_generation/QueryGraspsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(QueryGraspsActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cob_grasp_generation.msg.QueryGraspsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cob_grasp_generation.msg.QueryGraspsResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.result.grasp_list)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.grasp_list:
        _x = val1.id
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.result.grasp_list.append(val1)
      return self
