"""autogenerated by genpy from cob_grasp_generation/ShowGraspsActionResult.msg. Do not edit."""
import sys
...
class ShowGraspsActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "cob_grasp_generation/ShowGraspsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cob_grasp_generation/ShowGraspsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ShowGraspsActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cob_grasp_generation.msg.ShowGraspsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cob_grasp_generation.msg.ShowGraspsResult()
