"""autogenerated by genpy from cob_grasp_generation/QueryGraspsActionGoal.msg. Do not edit."""
import sys
...
class QueryGraspsActionGoal(genpy.Message):
  _md5sum = "e01d10fa638d30f8ffca451f7d03e368"
  _type = "cob_grasp_generation/QueryGraspsActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','cob_grasp_generation/QueryGraspsGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(QueryGraspsActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = cob_grasp_generation.msg.QueryGraspsGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = cob_grasp_generation.msg.QueryGraspsGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2Id.pack(_x.goal.grasp_id, _x.goal.num_grasps, _x.goal.threshold))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.grasp_id, _x.goal.num_grasps, _x.goal.threshold,) = _struct_2Id.unpack(str[start:end])
      return self
