"""autogenerated by genpy from cob_lookat_action/LookAtGoal.msg. Do not edit."""
import sys
...
class LookAtGoal(genpy.Message):
  ...
  _type = "cob_lookat_action/LookAtGoal"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_7d.pack(_x.target.pose.position.x, _x.target.pose.position.y, _x.target.pose.position.z, _x.target.pose.orientation.x, _x.target.pose.orientation.y, _x.target.pose.orientation.z, _x.target.pose.orientation.w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.target.pose.position.x, _x.target.pose.position.y, _x.target.pose.position.z, _x.target.pose.orientation.x, _x.target.pose.orientation.y, _x.target.pose.orientation.z, _x.target.pose.orientation.w,) = _struct_7d.unpack(str[start:end])
      return self
