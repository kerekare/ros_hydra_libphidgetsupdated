...
class Detection(genpy.Message):
  _md5sum = "0e10cbf79379d085e3459569bbe22c63"
...
"""
  __slots__ = ['header','label','detector','score','mask','pose','bounding_box_lwh']
  _slot_types = ['std_msgs/Header','string','string','float32','cob_object_detection_msgs/Mask','geometry_msgs/PoseStamped','geometry_msgs/Point']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,label,detector,score,mask,pose,bounding_box_lwh
