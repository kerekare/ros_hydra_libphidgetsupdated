...
if("TRUE" STREQUAL "TRUE")
  set(ur_driver_SOURCE_PREFIX /home/kerekare/workspace/care-o-bot/src/universal_robot/ur_driver)
  set(ur_driver_DEVEL_PREFIX /home/kerekare/workspace/care-o-bot/devel)
  ...
  set(ur_driver_INSTALL_PREFIX /home/kerekare/workspace/care-o-bot/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ur_driver' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Shaun Edwards <sedwards@swri.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ur_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kerekare/workspace/care-o-bot/src/universal_robot/ur_driver/${idir}'.  Ask the maintainer 'Shaun Edwards <sedwards@swri.org>' to fix it.")
    endif()
...
set(ur_driver_EXPORTED_TARGETS "")
