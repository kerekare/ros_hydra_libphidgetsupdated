...
if("TRUE" STREQUAL "TRUE")
  set(ur_gazebo_SOURCE_PREFIX /home/kerekare/workspace/care-o-bot/src/universal_robot/ur_gazebo)
  set(ur_gazebo_DEVEL_PREFIX /home/kerekare/workspace/care-o-bot/devel)
  ...
  set(ur_gazebo_INSTALL_PREFIX /home/kerekare/workspace/care-o-bot/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ur_gazebo' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Shaun Edwards <sedwards@swri.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ur_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kerekare/workspace/care-o-bot/src/universal_robot/ur_gazebo/${idir}'.  Ask the maintainer 'Shaun Edwards <sedwards@swri.org>' to fix it.")
    endif()
