...
if(NOT "include;/opt/ros/hydro/include/opencv;/opt/ros/hydro/include;/usr/include" STREQUAL "")
  set(cob_vision_utils_INCLUDE_DIRS "")
  set(_include_dirs "include;/opt/ros/hydro/include/opencv;/opt/ros/hydro/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'cob_vision_utils' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kerekare/workspace/care-o-bot/install/${idir}'.  Ask the maintainer 'Jan Fischer <jsf@ipa.fhg.de>' to fix it.")
    endif()
