...
cd "/home/kerekare/workspace/care-o-bot/src/cob_manipulation/cob_moveit_interface"
...
/usr/bin/env \
    ...
    build --build-base "/home/kerekare/workspace/care-o-bot/build/cob_manipulation/cob_moveit_interface" \
    install \
    $DESTDIR_ARG \
