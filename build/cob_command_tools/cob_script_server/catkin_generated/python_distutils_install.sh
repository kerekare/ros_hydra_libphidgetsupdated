...
cd "/home/kerekare/workspace/care-o-bot/src/cob_command_tools/cob_script_server"
...
/usr/bin/env \
    ...
    build --build-base "/home/kerekare/workspace/care-o-bot/build/cob_command_tools/cob_script_server" \
    install \
    $DESTDIR_ARG \
